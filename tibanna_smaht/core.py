...
from .stepfunction import StepFunctionTiger
...
class API(_API):
    ...
    def lambdas_module(self):
        from . import lambdas as tiger_lambdas
        return tiger_lambdas

    @property
    def tibanna_packages(self):
        import tibanna
        import tibanna_ffcommon
        import tibanna_smaht
        return [tibanna, tibanna_ffcommon, tibanna_smaht]

    StepFunction = StepFunctionTiger
    ...
    def deploy_tiger(self, suffix=None, usergroup='', subnets=None, security_groups=None, env=None,
